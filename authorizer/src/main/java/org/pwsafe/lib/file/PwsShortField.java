...
public class PwsShortField extends PwsField
{
     ...
     * <code>PwsShortField</code>.
     * @see java.lang.Comparable#compareTo(java.lang.Object)
     */
    public int compareTo(@NonNull Object other)
    {
        return ((Short)getValue()).compareTo(
                (Short)((PwsShortField)other).getValue());
    }

    /**
     * Compares this field's value to another <code>PwsShortField</code> or an
     * Short.  It returns <code>true</code> if they are equal and
     ...
     * <code>PwsShortField</code> nor an <code>Short</code>.
     */
    @Override
    public boolean equals(Object arg0)
    {
        if (arg0 instanceof PwsShortField) {
            return getValue().equals(((PwsShortField)arg0).getValue());
