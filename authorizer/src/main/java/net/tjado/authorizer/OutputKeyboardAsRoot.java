...
public class OutputKeyboardAsRoot implements OutputInterface
{

    private String devicePath = "/dev/hidg0";
    private UsbHidKbd kbdKeyInterpreter;

    private static final String TAG = "OutputKeyboardAsRoot";

    public OutputKeyboardAsRoot(Language lang)
    {
